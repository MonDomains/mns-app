...
ARG VITE_APP_REGISTER_CONTROLLER
ARG VITE_APP_NODE_ENV
ARG VITE_APP_NATIVE_TOKEN
ARG VITE_APP_PUBLIC_RESOLVER
...
ENV VITE_APP_REGISTER_CONTROLLER=$VITE_APP_REGISTER_CONTROLLER
ENV VITE_APP_NODE_ENV=$VITE_APP_NODE_ENV
ENV VITE_APP_NATIVE_TOKEN=$VITE_APP_NATIVE_TOKEN
ENV VITE_APP_PUBLIC_RESOLVER=$VITE_APP_PUBLIC_RESOLVER
