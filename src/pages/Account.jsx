                    ...
                    { data.domains.map((domain) => (
                      <>
                        <li className="list-group-item" key={domain.id}>
                          <NavLink to={"/name/"+ domain.name } className={"text-decoration-none link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover d-flex flex-row justify-content-between align-items-center"}>
                            <div className="d-flex flex-row gap-2">
                              <img className="rounded-2" width={64} src={import.meta.env.VITE_APP_METADATA_URL + "/"+ getTokenId(domain.labelName) + "/image"} alt={domain.name} />
                            ...
                            <div className="d-flex flex-row gap-2">
                              <span class="badge bg-success-subtle text-success-emphasis">Owner</span>
